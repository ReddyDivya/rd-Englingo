  ...
  return (
    ...
    <nav className="app__navbar">
      ...
      <ul className="app__navbar-links">
        ...
        {/*menu*/}
        {['vocabulary', 'idioms', 'sentences', 'instead-of-very', 'synonyms', 'advanced-Phrases', 'OtherWays'].map((item) => (
      ...
      <div className="app__navbar-menu">
        ...
        {toggle && (
          ...
          >
            ...
            <ul>
              {['vocabulary', 'idioms', 'sentences', 'very', 'synonyms', 'advancedPhrases'].map((item) => (
                <li key={item}>
